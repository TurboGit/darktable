...
static int
default_distort_transform(dt_iop_module_t *self, float *points, int points_count)
{
  return 1;
}
static int
default_distort_backtransform(dt_iop_module_t *self, float *points, int points_count)
{
  return 1;
}
